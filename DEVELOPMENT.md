...
```bash
git remote add encore encore://safety-audit-system-iedi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/safety-audit-system-iedi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/safety-audit-system-iedi/settings/integrations/github)
